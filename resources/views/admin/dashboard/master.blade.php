...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">
                    <i class="fas fa-user-tie text-primary"></i> Master Dashboard
                </h1>
            </div>
            <div class="col-sm-6">
...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="alert alert-primary">
            ...
            You are viewing the Master Dashboard with access to your agents and their players.
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="stats-card" style="background: linear-gradient(135deg, #28a745 0%, #20c997 100%);">
                    ...
                    <p>SubAgents</p>
                    <small>SubAgents under your agents</small>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="stats-card" style="background: linear-gradient(135deg, #17a2b8 0%, #138496 100%);">
                    ...
                    <p>Total Players</p>
                    <small>Players in your network</small>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="recent-activity">
                    <h5><i class="fas fa-users"></i> Recent Agents</h5>
                        ...
                        <div class="activity-item">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <br>
                                    <small class="text-muted">{{ $agent->name ?? 'N/A' }}</small>
                                </div>
                                <div class="text-right">
                                    <span class="badge badge-success badge-custom">Agent</span>
                                    <br>
                                    <strong>{{ number_format($agent->balance, 2) }}</strong>
                                    <br>
                    ...
                    @empty
                        <p class="text-muted text-center">No agents yet</p>
                    @endforelse
                </div>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-3">
                                <a href="{{ route('admin.agent.index') }}" class="btn btn-primary btn-block">
                                    <i class="fas fa-users"></i> Manage Agents
                                </a>
                            </div>
                            <div class="col-md-3">
                                <a href="{{ route('admin.player.index') }}" class="btn btn-success btn-block">
